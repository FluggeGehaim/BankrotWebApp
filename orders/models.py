...
class OrderItem(models.Model):
    ...
    product = models.ForeignKey(to=Lots, on_delete=models.SET_DEFAULT, null=True, verbose_name="Продукт", default=None)
    ...
    def products_price(self):
        return round(self.lots_price() * self.quantity, 2)
